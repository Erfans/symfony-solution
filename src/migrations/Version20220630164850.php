 ...
 */
final class Version20220630164850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attraction ADD created_user_id INT DEFAULT NULL, ADD updated_user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE hotel ADD created_user_id INT DEFAULT NULL, ADD updated_user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE message ADD created_user_id INT DEFAULT NULL, ADD updated_user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE room ADD created_user_id INT DEFAULT NULL, ADD updated_user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE attraction DROP created_user_id, DROP updated_user_id');
        ...
        $this->addSql('ALTER TABLE hotel DROP created_user_id, DROP updated_user_id');
        ...
        $this->addSql('ALTER TABLE message DROP created_user_id, DROP updated_user_id');
        ...
        $this->addSql('ALTER TABLE room DROP created_user_id, DROP updated_user_id');
    }
}
